...
//             }}
//           >
//             <Text style={[styles.modeButtonText, { color: this.state.isVideoMode ? 'white' : 'yellow' }]}>Photo</Text>
//           </TouchableOpacity>
//           <TouchableOpacity
//             style={styles.modeButton}
//             onPress={() => {
...
//             }}
//           >
//             <Text style={[styles.modeButtonText, { color: this.state.isVideoMode ? 'yellow' : 'white' }]}>Video</Text>
//           </TouchableOpacity>
//         </View>
//         <View
//           style={{
...
//                   console.log("Video Mode is true")
//                   if (!this.state.isVideoRecording) {
//                     this.setState({ isVideoRecording: true });
//                     let video = await cameraRef.recordAsync({ mute: true });
//                     try {
...
//                   }
//                 } else {
//                   console.log("Video Mode is false")
//                   this.handlePhoto(cameraRef, data);
//                 }
//               }}
//             >
