...
from osd.structures.bounding_box import BoxList, cat_boxlist, boxlist_iou, nms
from osd.utils import masked_select_or_fill_constant
...
class BoxGridGenerator:
    ...
    def  get_box_to_cut_anchor(self, img_size, crop_size, fm_size, default_box_transform=None):
       ...
       # a.append(box_left,box_top,box_right,box_bottom)
       # print(a)
